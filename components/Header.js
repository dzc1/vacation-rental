...
import { SearchIcon, UserCircleIcon, GlobeAltIcon, MenuIcon } from '@heroicons/react/outline'
...
const selectionRange = {
    ...
    return (
        <header className="sticky top-0 z50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            {/* left */}
            <div 
            onClick={() => router.push("/") } 
